...
Using the NT and South WA station groups as case studies, Figures \ref{Fig:case_studies} a) and b) provide time series of $\text{wpi}_\text{OA}$ and $\text{wpi}_\text{OE}$ for, a), the South WA station group at 05:00 UTC, and b), the NT station group at 23:00 UTC. Although the $\overline{\text{wpi}}$ values for the South WA station at 05:00 UTC are small, the time series shows there is significant variability over the three month time period, with $\text{wpi}_\text{OA}$ and $\text{wpi}_\text{OE}$ each exceeding 1 kn on at least 9 seperate days. Both $\text{wpi}_\text{OA}$ and $\text{wpi}_\text{OE}$ exceed 1 kn on the 9\textsuperscript{th} of June and the 2\textsuperscript{nd} of August. The $\text{wpi}_\text{OA}$ and $\text{wpi}_\text{OE}$ values for the NT station group also show significant temporal variability, exceeding $-2$ kn on at least 10 days each.    

Figures \ref{Fig:case_studies} c) and d) show hodographs of the winds and wind perturbations, respectively, at each hour UTC for the AWS observations, Official forecast, and ACCESS and ECMWF model datasets on the 9\textsuperscript{th} of June, which is the more interesting example. The perturbation hodograph shows both ECMWF and ACCESS underpredicting the amplitude of the diurnal wind cycle on this day. In each dataset the 05:00 UTC perturbations are westerly to northwesterly, and given the orientation of the South WA coastline (see Fig.~\ref{Fig:map}) and the fact that 05:00 UTC corresponds to $\approx$ 13:00 local solar time (LST) in this region, the perturbations likely indicate boundary layer mixing processes, rather than the land-sea breeze. Furthermore, the AWS perturbations rapidly become northwesterly between 01:00 and 02:00 UTC, $\approx$ 09:00 - 10:00 LST, which would be about three hours after the sun has risen, consistent with a boundary layer mixing mechanism.  

Figure \ref{Fig:perth_sounding} provides hodographs of wind with height throughout the first two km of the atmosphere between 12:00 UTC on the 8\textsuperscript{th} June and 12:00 UTC on the 9\textsuperscript{th} June; the soundings were taken at Perth Airport, which is the nearest station to the South WA station group that provides wind data above the surface. The 8\textsuperscript{th} June 12:00 UTC hodograph shows surface northerlies of $\approx 6$ kn, becoming west to northwesterlies of over 20 kn at $2.4$ km above the surface. A forecaster basing a model edit of the following days winds on this sounding would therefore gradually strengthen the westerly component of the surface winds in the hours after sunrise. However, the subsequent sounding at 00:00 UTC on the 9\textsuperscript{th} of June shows that the winds aquire a strong northerly component of 30 kn in the first 500 m of the atmosphere, with the final sounding idicating a strong northwesterly wind at 725 m persisting until 12:00 UTC. In Fig.~\ref{Fig:case_studies} d), the Official perturbations from 04:00 to 07:00 UTC show stronger westerly perturbations than either ACCESS or ECMWF. This means the amplitudes of the Official and AWS diurnal cycles are in closer agreement than of Official and ACCESS or ECMWF. However, the AWS perturbations are more northerly than those of Official, which are more westerly. An explanation for this discrepancy that is consistent with Fig.~\ref{Fig:perth_sounding}, is that the Official day 1 forecast for the 9\textsuperscript{th} of June in the southwest part of WA has been issued based on the Perth Airport sounding at 12:00 UTC of the previous day, with the winds above the surface then becoming significantly northerly over the following 12 hours, and the winds actually mixed through the boundary layer between 01:00 and 02:00 UTC on the 8\textsuperscript{th} being more northerly as a result.

Turning now to the NT station group, Fig.~\ref{Fig:case_studies} d) shows that $\text{wpi}_\text{OA}$ and $\text{wpi}_\text{OE}$ both exceed -2 kn on four different days. Figures \ref{Fig:case_studies} e) and f) are analogous to Figures \ref{Fig:case_studies} c) and d), but are for the NT station group on the 3\textsuperscript{rd} of July, which provides an interesting example. 
