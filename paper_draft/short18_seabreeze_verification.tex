...
\centering
\includegraphics[keepaspectratio=true,width=0.90\textwidth]{figure_placeholder.png}
\caption{Official vs Access and Official vs ECMWF WPI values, standard deviations and confidence. single station and/or airport station groups for comparison?}
\label{Fig:airport_wpi}
\end{figure}
...
\centering
\includegraphics[keepaspectratio=true,width=0.90\textwidth]{figure_placeholder.png}
\caption{Actual perturbation standard deviation values.}
\label{Fig:airport_wpi}
\end{figure}
